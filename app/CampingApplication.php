 ...
 */
    class CampingApplication extends Model {
        ...
        protected $encrypted = ['pcn', 'first_name', 'last_name', 'phone', 'email', 'ip_address', 'address', 'city', 'postal', 'remarks'];
        ...
        public $fillable = ['pcn', 'first_name', 'last_name', 'phone', 'email', 'birthday', 'address', 'city', 'postal', 'remarks'];
