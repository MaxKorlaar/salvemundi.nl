    ...
    namespace App\Mail;
        ...
        class NewMemberApplication extends Mailable {
            ...
            public function build() {
                return $this->view('emails.new_member_application')->attach($this->application->getImagePath(), ['as' => 'pasfoto_' . $this->application->pcn])->text('emails.plaintext.new_member_application');
            }
        }
