<?php
    ...
    class UpdateIntro extends FormRequest {
        ...
        public static function rules() {
            return [
                'reservations_open'              => 'required|date|after:-12 months',
                'mail_reservations'              => 'boolean',
                'allow_reservations_after_limit' => 'boolean',
                'signup_open'                    => 'required|date|after:-12 months',
                'signup_close'                   => 'required|date|after:-12 month',
                'supervisor_signup_close'        => 'required|date|after:-12 month',
