        ...
        'signup' => [
            ...
            'questions'           => [
                ...
                [
                    ...
                    'Het kamp begint op vrijdag 23 november 2018 en zal duren tot zondag 25 november 2018. We zullen pas na schooltijden beginnen, vrij houden van school is dus niet nodig. De exacte vertrektijd en locatie ontvang je later per e-mail.'
                ],
                [
                    'Dat is zeker niet gratis?',
                    'Nee, helaas niet. Je betaalt slechts €:price voor het hele weekend. Dit is "all-inclusive". Dit houdt in dat je voor €:price het hele weekend kan genieten van de activiteiten, eten en drinken. En om de brandende vraag gelijk maar te beantwoorden, ja dat houdt ook in onbeperkt bier, wijn en fris. Meer drank de man!'
                ],
                [
                    'Hoe komen we op de kamplocatie?',
                    'Met een oude, in de tijd verloren, techniek genaamd "de fiets". We zullen op de fiets vertrekken vanaf Fontys R1 en fietsen naar onze kamplocatie met tussendoor een aantal tussenstops (Zorg dus dat je op tijd een fiets in Eindhoven hebt). Ga je zelf een andere vorm van vervoer regelen, bespreek dit op tijd met de kampcommissie!'
                ],
                [
                ...
                [
                    ...
                    'In het geval van medicijnen / allergieën dien je dit tijdens je inschrijving aan te geven. Meld ons welke vorm van medicijnen je slikt, hoe vaak en wanneer op de dag je deze slikt zodat wij hier rekening mee kunnen houden. En in geval van nood met wie we contact op moeten nemen.'
                ],
                [
                    'Waar moet ik rekening mee houden?',
                    'Je moet er rekening mee houden dat je niet te veel waardevolle spullen meeneemt. Salve Mundi is niet aansprakelijk te stellen voor schade, diefstal en andere vormen van kwalen op je eigendom.'
                ],
                [
                ...
                [
                    'Wordt het net zo leuk als vorig jaar?',
                    'Nee, leuker!'
                ]
            ],
