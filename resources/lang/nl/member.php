    ...
    return [
        ...
        'membership'  => [
            'renew'   => [
                ...
                'email_instructions'       => 'Bedankt voor het verlengen van je lidmaatschap van MediaMeiden! Je betaling wordt momenteel verwerkt in ons systeem, maar zodra deze succesvol is afgerond krijg je van ons een mailtje ter bevestiging met meer informatie. Mocht je de email niet krijgen binnen 2 werkdagen nadat de betaling is afgerond, kijk dan in je map voor ongewenste email of neem contact met ons op.',
                'already_renewed'          => 'Je lidmaatschap is al verlengd! Je bent op dit moment een actief lid van MediaMeiden.'
            ],
            'payment' => [
                'description' => 'Contributie MediaMeiden voor :first_name :last_name',
        ...
        'about_me'    => [
            'title'            => 'Over mij',
            'greeting'         => 'Hallo :name!',
            'change_your_info' => 'De onderstaande gegevens zijn bekend bij ons. Klopt er iets niet? <a href="mailto:privacy@mediameiden.korlaar.net">Neem dan alsjeblieft contact met ons op</a> zodat we dit kunnen oplossen.',
            'member_id'        => 'Lidnummer',
            'pcn'              => 'PCN',
            ...
            'renew_terms'                      => 'Door je lidmaatschap te verlengen ga je akkoord met de <a target="_blank" href="https://drive.google.com/uc?export=open&id=1ZGaXvr1_b0ToqtzQDqTl0YaGmoymvUpp">algemene voorwaarden</a> van MediaMeiden en ons <a href="' . route('privacy') . '" target="_blank">privacybeleid</a>.',
