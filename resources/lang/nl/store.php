<?php
    ...
    return [
        ...
        'info'        => [
            'title' => 'Merchandise',
            'intro' => [
                "Welkom bij de officiële merchandise pagina van MediaMeiden!",
        ...
        'cart'        => [
            ...
            'order_terms'                 => 'Door een bestelling te plaatsen ga je akkoord met <a href="https://drive.google.com/uc?export=open&id=1ZGaXvr1_b0ToqtzQDqTl0YaGmoymvUpp" target="_blank">de huisregels van MediaMeiden</a> en dat je gegevens worden verwerkt volgens ons <a href="' . route('privacy') . '" target="_blank">privacybeleid</a>.',
            ...
            'payment_description'         => 'Bestelling van MediaMeiden webshop',
        ...
        'order'       => [
            'confirmation' => [
                ...
                'email_instructions' => 'Bedankt voor het plaatsen van je bestelling bij MediaMeiden! We hebben je bestelling ontvangen en nemen binnenkort contact met je op. Meer informatie over je bestelling is zojuist naar je e-mailadres toegestuurd.'
            ]
        ],
        'item'        => [
            'variant'      => 'Uitvoering',
            'no_stock'     => 'Geen op voorraad',
            'not_in_stock' => 'Niet meer op voorraad? Niet getreurd! Houd deze pagina in de gaten om op de hoogte blijven wanneer het product weer op voorraad is. Ook is het mogelijk om een mail naar media@mediameiden.korlaar.net te sturen om aan te geven dat jij interesse hebt in dit product!'
        ],
        'collections' => [
            'title' => "Bekijk hieronder de MediaMeiden merchandise collectie",
        ],
    ];