<?php
    ...
    return [
        ...
        'email'                    => 'E-mailadres',
        'email_missing'            => 'Om gebruik te maken van de MediaMeiden website, is het nodig om toestemming te verlenen tot het gebruik van je e-mailadres.',
        'access_denied'            => 'Verleen toestemming tot je accountgegevens om in te loggen tot de MediaMeiden website.',
        'password'                 => 'Wachtwoord',
        ...
        'password_reset'           =>
            [
                ...
                'password_help'    => 'Kies een veilig en willekeurig wachtwoord. Deel dit niet en gebruik het ook niet op andere websites.',
                'errors_occurred'  => 'Er is een fout opgetreden.|Er zijn meerdere fouten opgetreden.',
                'get_link'         => 'Verkrijg reset-link',
                'do_reset'         => 'Stel nieuw wachtwoord in',
            ],
    ];
